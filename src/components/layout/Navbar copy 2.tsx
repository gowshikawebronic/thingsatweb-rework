...
export default function Navbar() {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <nav className="hidden md:flex gap-8 items-center font-medium text-sm tracking-wide h-full relative">
                    ...
                    {mounted && (
                        <button
                            onClick={toggleTheme}
                            className="ml-2 w-10 h-10 rounded-full flex items-center justify-center text-foreground hover:bg-brand-surface dark:hover:bg-gray-800 transition-colors"
                ...
                <div className="flex items-center gap-1 md:hidden z-[60] pointer-events-auto">
                    {mounted && (
                        <button
                            onClick={toggleTheme}
                            className="w-10 h-10 rounded-full flex items-center justify-center text-foreground hover:bg-brand-surface dark:hover:bg-gray-800 transition-colors"
                            aria-label="Toggle Theme"
                        >
                            {currentTheme === 'dark' ? <Sun size={20} /> : <Moon size={20} />}
                        </button>
                    ...
                    <button
                        onClick={toggleMenu}
                        className="p-2 focus:outline-none shrink-0 relative w-10 h-10 flex flex-col items-center justify-center"
            ...
            <div
                className={`fixed inset-0 bg-background/95 backdrop-blur-2xl z-40 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] flex flex-col pt-32 px-8 pb-12 overflow-y-auto pointer-events-auto ${isMenuOpen ? "translate-y-0" : "-translate-y-full"
                    }`}
            >
                <div className="flex flex-col gap-6 w-full max-w-sm mx-auto">
                    ...
                    <div className="border-b border-gray-100 pb-4">
                        ...
                        <div
                            className={`grid transition-all duration-500 ease-in-out ${activeAccordion === "services" ? "grid-rows-[1fr] opacity-100 mt-4" : "grid-rows-[0fr] opacity-0"
                                }`}
                        >
                    ...
                    <div className="border-b border-gray-100 pb-4">
                        ...
                        <div
                            className={`grid transition-all duration-500 ease-in-out ${activeAccordion === "products" ? "grid-rows-[1fr] opacity-100 mt-4" : "grid-rows-[0fr] opacity-0"
                                }`}
                        >
                            <div className="overflow-hidden flex flex-col gap-4 pl-4">
